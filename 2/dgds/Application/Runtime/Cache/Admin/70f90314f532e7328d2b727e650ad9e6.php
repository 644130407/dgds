...
<html>
    ...
    <body>
        <form name="form1" method="post" action="<?php echo U('Home'.'/User/userUpdate');?>" onsubmit="return check()">
            <table>
                <tr>
                    <td>
                        用户名：
                ...
                <tr align="center">
                    <td align="center">
                        <input type="submit" value="修改信息" name="text9"><input type="reset" value="重置" name="text10">
                    </td>
                </tr>
            </table>
        </form>

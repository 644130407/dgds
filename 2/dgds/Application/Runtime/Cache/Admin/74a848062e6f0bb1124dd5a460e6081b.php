                ...
                <div>
                    <table class="table table-border table-bordered">
                        ...
                        <?php if(is_array($user)): foreach($user as $key=>$v): ?><tr>
                                ...
                                <td width="15%">
                                    <a href="<?php echo u('Userlist/update',array('id'=>$v['id']));?>" class="btn btn-primary">修改</a>
                                    <!--[<a href="<?php echo U('Userlist/update');?>">修改</a>]-->
                                    <a href="<?php echo u('Userlist/delet',array('id'=>$v['id']));?>" class="btn btn-danger radius">删除</a>
                                </td>
                                </td>

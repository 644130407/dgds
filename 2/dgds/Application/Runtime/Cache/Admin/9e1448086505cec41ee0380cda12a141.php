            ...
            <div class="pd-20">
                ...
                <div class="bk-gray">
                    ...
                    <div class="bk-gray radius">
                        <form  action="<?php echo U('Admin'.'/Article/cchange');?>" method="post">
                            <table class="table table-border table-bordered radius">
                                ...
                                <tr><td> 输入时间：</td><td><input  type="date" value="<?php echo ($v["time"]); ?>" name="time" class="input-text radius size-M"></td></tr>

                                <tr> <td>输入专栏名：</td><td>
                                        <select class="select" size="1" name="column">

                                            <option name='column' value="<?php echo ($article[0]['column']); ?>" selected><?php echo ($article[0]['cname']); ?></option>
                                            </foreach>
                                ...
                                <tr> <td>输入小类别：</td><td>
                                        <span class="select-box">
                                            <select class="select" size="1" name="ctype">
                                                ...
                                                <option name='ctype' value="<?php echo ($article[0]['ctype']); ?>" selected><?php echo ($article[0]['tname']); ?></option>
                                                <?php if(is_array($ctype)): foreach($ctype as $key=>$v): ?><option value="<?php echo ($v["cid"]); ?>" name='ctype'><?php echo ($v["tname"]); ?></option><?php endforeach; endif; ?>
                                            </select>
                                        </span></td></tr>
                                <?php if(is_array($article)): foreach($article as $key=>$v): ?><tr><td> 输入内容</td><td><textarea id="contents" name="content"><?php echo ($v["content"]); ?></textarea></td></tr><?php endforeach; endif; ?>

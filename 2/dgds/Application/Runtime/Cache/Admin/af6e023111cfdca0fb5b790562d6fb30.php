...
<html>
    ...
    <body>
            ...
            <table>
                <?php if(is_array($user)): foreach($user as $key=>$user): ?><form name="form1" method="post" action="<?php echo U('Userlist/infoUpdate');?>" onsubmit="return check()">
                <tr>
                    <td>ID:</td>
                    <td><input  value="<?php echo ($user["id"]); ?>" name="id" type="hidden"></td>
                </tr>
                <tr>
                    <td>
                        用户名：
                    ...
                    <td>
                        <input id="text0" type="text" name="username" value="<?php echo ($user["username"]); ?>" disabled>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input id="text1" type="password" name="oldpassword" onblur="check()">
                ...
                <tr>
                    ...
                    <td>
                        <input id="text4" type="text" name="realname" onblur="check()" value="<?php echo ($user["realname"]); ?>">
                ...
                <tr>
                    ...
                    <td>
                        <input id="text5" type="text" name="gender" onblur="check()" value="<?php echo ($user["gender"]); ?>">
                ...
                <tr>
                    ...
                    <td>
                        <input id="text6" type="text" name="phone" onblur="check()" value="<?php echo ($user["phone"]); ?>">
                ...
                <tr>
                    ...
                    <td>
                        <input id="text7" type="text" name="email" onblur="check()" value="<?php echo ($user["email"]); ?>">
                ...
                <tr>
                    ...
                    <td>
                        <input id="text8" type="text" name="department" onblur="check()"  value="<?php echo ($user["department"]); ?>">

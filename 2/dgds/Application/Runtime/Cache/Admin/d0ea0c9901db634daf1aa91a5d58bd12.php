                ...
                <div>
                    <table class="table table-border table-bordered">
                        ...
                        <?php if(is_array($pic)): foreach($pic as $key=>$v): ?><tr>
                                ...
                                <td width="10%"><image src="/dgds_6.18/2/dgds/Public/Uploads/Video/<?php echo ($v["path"]); echo ($v["name"]); ?>" style="width:100px;height: 100px"/></td>
                                <td width="10%"><?php echo (date('y-m-d H:i',$v["create_time"])); ?></td>
                                <td width="15%"><?php echo ($v["link"]); ?></td>
                                <td width="20%">

                                    <a class="btn btn-primary" href="/dgds_6.18/2/dgds/Public/Uploads/Video/<?php echo ($v["path"]); echo ($v["image"]); ?>">查看详情</a>
                        ...
                        <tr>
                        <form action="<?php echo u('Admin'.'/Videonews/upload');?>" enctype="multipart/form-data" method="post" >
                            <td>输入您想更改的视频id：<input type="text"  name="id" class="input-text radius size-M"/></td>
                            <td> 请输入您想更变的视频链接：<input type="text"  name="link" class="input-text radius size-M"/></td>
                            <td><input type="text"  name="lable" class="input-text radius size-M"/></td><td></td>
                            <td> 上传您需要显示在首页的视频：<input type="file"  name="photo1" class="input-text radius size-M"/></td>

...
<html>
    ...
    <body>
        <form name="form1" method="post" action="<?php echo U('Home'.'/User/userRegister');?>" onsubmit="return check()">
            <table>
                <tr>
                    <td>
                        用户名：
                ...
                <tr>
                    ...
                    <td>
                        <input id="text7" type="text" name="realname" onblur="check()">
                ...
                <tr>
                    ...
                    <td>
                        <input id="text8" type="text" name="gender" onblur="check()">
                ...
                <tr>
                    ...
                    <td>
                        <input id="text5" type="text" name="phone" onblur="check()">
                ...
                <tr>
                    ...
                    <td>
                        <input id="text6" type="text" name="department" onblur="check()">

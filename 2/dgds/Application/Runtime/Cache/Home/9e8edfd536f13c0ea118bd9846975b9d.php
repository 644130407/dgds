        ...
        <div class="box">
            ...
            <div class="detail_main">
                <div class="detail_main_left">
                    <p class="detail_main_left_p1">当前位置：<a href="<?php echo U('Index/index');?>">首页</a>>><a href="#">更多</a></p>
                    <p class="detail_main_left_p2"><span>相关文章</span></p>
                    <ul>
                        <?php if(is_array($article)): foreach($article as $key=>$v): ?><li><a href="<?php echo U('Index/detil',array('id'=>$v['id']));?>"><?php echo ($v["lable"]); ?><em><?php echo (date('y-m-d H:i',$v["time"])); ?></em></a></li><?php endforeach; endif; ?>
                    </ul>
                ...
                <div class="detail_main_right">
                    <div class="detail_main_right_bai"></div>
                    <div class="detail_main_right_top">
                        <div class="detail_main_right_title1">
                            <span>站内搜索</span>
                        </div>
                        ...
                        <div class="detail_main_right_title2">
                            <span>本站推荐</span><a href="<?php echo U('Articlelist/alist',array('type'=>1));?>">>>更多</a>
                        </div>
                        <ul>
